...
if sys.argv[1] == 'lw':
    lw = True
    fig_title =  'Решение уравнения переноса по схеме Лакса-Вендроффа с периодическими граничными условиями '
elif sys.argv[1] == 'u':
    lw = False
    fig_title = 'Решение уравнения переноса по схеме с разностями против потока с периодическими граничными условиями '
else:
...
y0 = np.sin(4. * np.pi * x / L)   # Начальные условия y(x, 0)
